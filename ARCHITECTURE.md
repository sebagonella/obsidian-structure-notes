...
- **2026-05-15** — Subpastas de `30_AREAS/FINANCAS/CONTROLES/` renomeadas para caixa baixa seguindo convenção do vault; referências atualizadas nos arquivos de projeto afetados e nota de tarefa de normalização de metadados.
